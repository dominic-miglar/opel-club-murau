                    ...
                    <div class="blog-post-body">
                        ...
                        {{ Form::open(array('url' => '/cars/'.$car->id.'/', 'method' => 'put', 'class' => 'form-horizontal')) }}
                            ...
                            @endif
                                ...
                                <div class="col-sm-10">
                                    {{ Form::text('manufacturer', $car->manufacturer, ['class' => 'form-control', 'placeholder' => 'Hersteller']) }}
                            ...
                            @endif
                                ...
                                <div class="col-sm-10">
                                    {{ Form::text('model', $car->model, ['class' => 'form-control', 'placeholder' => 'Modell']) }}
                                    {{ $errors->first('model') }}
                                </div>
                            </div>
                            ...
                            @endif
                                ...
                                <div class="col-sm-10">
                                    {{ Form::textarea('description', $car->description, ['class' => 'form-control', 'placeholder' => 'Beschreibung']) }}
                            ...
                            @endif
                                ...
                                <div class="col-sm-10">
                                    {{ Form::number('horsepower', $car->horsepower, ['class' => 'form-control', 'placeholder' => 'Leistung (PS)']) }}
                            ...
                            @endif
                                ...
                                <div class="col-sm-10">
                                    {{ Form::number('yearBuilt', $car->yearBuilt, ['class' => 'form-control', 'placeholder' => 'Baujahr']) }}
                                    {{ $errors->first('horsepower') }}
                                </div>
                            </div>
                            ...
                            @endif
                                ...
                                <div class="col-sm-10">
                                    {{ Form::select('member', Member::getSelectSet(), $car->member->id, ['class' => 'form-control']); }}
                                    {{ $errors->first('member') }}
                                </div>
                            </div>
