            ...
            <div class="blog-main">
                <div class="blog-post">
                    ...
                    <div class="blog-post-body">
                        ...
                        @endif
                        {{ Form::open(array('url' => '/description/'.$article->id.'/', 'method' => 'put', 'class' => 'form-horizontal')) }}
                        ...
                        @if($article->locked == false)
                            {{ Form::open(array('url' => '/description/'.$article->id.'/', 'method' => 'delete', 'class' => 'form-horizontal')) }}
